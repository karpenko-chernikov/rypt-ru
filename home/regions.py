"""Справочник субъектов РФ для карты (коды ISO 3166-2:RU)."""
...
REGIONS = {
    ...
    'RU-SEV': 'Севастополь',  # есть на SVG, нет в исходном JSON
}

REGION_CHOICES = [(code, name) for code, name in REGIONS.items()]
